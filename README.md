...
| 项目                                                         | 描述                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Net](https://github.com/liangjingkanji/Net)                 | Android上最强大的网络请求/异步任务库 `[开发必备]`            |
| [BRV](https://github.com/liangjingkanji/BRV)                 | Android上最强大的RecyclerView库 `[开发必备]`                 |
| [Serialize](https://github.com/liangjingkanji/Serialize)     | 标准序列化工具, 创建自动序列化字段, `[开发必备]`             |
| [StateLayout](https://github.com/liangjingkanji/StateLayout) | 一行代码构建整个应用的缺省页                                 |
| [StatusBar](https://github.com/liangjingkanji/StatusBar)     | 一行代码配置透明状态栏和自定义颜色 `[开发必备]`              |
| [Channel](https://github.com/liangjingkanji/Channel)         | 一行代码发送和接收事件LiveData `[开发必备]`                  |
| [LogCat](https://github.com/liangjingkanji/LogCat)           | 日志输出工具 `[开发必备]`                                    |
| [Tooltip](https://github.com/liangjingkanji/Tooltip)         | 提醒工具(Toast/ProgressDialog), Kotlin特性/异步显示/无覆盖/全局单例配置/自定义等级/生命周期`[开发必备]` |
